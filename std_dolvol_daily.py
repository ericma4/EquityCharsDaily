...
# process dataframe
crsp_out = crsp_out.dropna(subset=['std_dolvol'])  # drop NA due to rolling
crsp_out = crsp_out.reset_index(drop=True)
crsp_out = crsp_out[['permno', 'date', 'std_dolvol']]

with open('std_dolvol_daily.feather', 'wb') as f:
