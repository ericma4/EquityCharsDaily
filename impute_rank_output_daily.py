...
with open('chars_daily_rank_no_impute.feather', 'wb') as f:
...
with open('chars_daily_rank_imputed.feather', 'wb') as f:
    feather.write_feather(df_rank, f)
