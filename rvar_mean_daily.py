...
crsp_out = crsp_out.rename(columns={'rvar': 'rvar_mean'})
crsp_out = crsp_out.reset_index(drop=True)
crsp_out = crsp_out[['permno', 'date', 'rvar_mean']]

with open('rvar_mean_daily.feather', 'wb') as f:
